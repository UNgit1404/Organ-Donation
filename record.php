...
{
    $sql2 = "SELECT * FROM request WHERE (email='$email' AND mci_register='$mci' AND passwordd ='$pswd')";
    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['blood_grp'];?></td>
                <td><?php echo $rows['organ'];?></td>
